...
mod tests {
    ...
    fn test_error_codes() {
        ...
        assert_eq!(McpError::Validation("invalid".into()).to_error_code(), -32002);
        assert_eq!(McpError::DuplicateCode("TASK-001".into()).to_error_code(), -32003);
        assert_eq!(McpError::InvalidStateTransition("Invalid".into()).to_error_code(), -32004);
        assert_eq!(McpError::Database("conn failed".into()).to_error_code(), -32005);
        assert_eq!(McpError::Protocol("bad request".into()).to_error_code(), -32006);
    }
