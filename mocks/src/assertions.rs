...
pub fn assert_task_equals(actual: &Task, expected: &Task) {
    ...
    assert_eq!(
        actual.owner_agent_name, expected.owner_agent_name,
        "Task owners don't match"
    );
